#searching array - you can search an array for a certain value and return the indexes that match. by using where()
...
#now we will fid the indexes where the values are even:
...
#now we will fid the indexes where the values are odd:
...
#now we will search from right sides
