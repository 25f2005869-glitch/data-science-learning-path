...
#now we will split the array in 4 parts:
...
#split the 2-D array into three 2-Dalong with rows
...
#alternate solution is using the hsplit(), opposite hssssssstack()
